...
let CurrencyTabs = React.createClass({
  ...
  render() {
    ...
    let tabs = React.Children.map(this.props.children, (tab, index) => {
      if (tab.type.displayName === "CurrencyTab" || tab.type === "CurrencyTab") {
        ...
        throw 'Tabs only accepts CurrencyTab Components as children. Found ' +
    ...
    return (
      <div style={this.mergeAndPrefix(this.props.style)}>
        ...
        <div style={{textAlign:'center', paddingLeft: '8px', paddingRight: '10px', backgroundColor: '#cceafb'}}>
