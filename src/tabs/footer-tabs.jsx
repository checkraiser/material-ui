...
let InkBar = require('../footer-ink-bar');
let StylePropable = require('../mixins/style-propable');
let Events = require('../utils/events');


let FooterTabs = React.createClass({
  ...
  render() {
    ...
    let tabs = React.Children.map(this.props.children, (tab, index) => {
      if (tab.type.displayName === "FooterTab" || tab.type === "FooterTab") {
        ...
        throw 'Tabs only accepts FooterTab Components as children. Found ' +
